...
\lstinputlisting[language=XML, caption=JaCoCo Maven Plugin Configuration]{../config/jacoco-config.xml}

\subsection{PITest Configuration}
\lstinputlisting[language=XML, caption=PITest Maven Plugin Configuration]{../config/pitest-config.xml}
...
[Include full security scan results]
